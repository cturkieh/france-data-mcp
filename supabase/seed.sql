...
-- code_departement requis depuis la migration 13. Sans cette colonne,
-- finess_by_categorie filtre sur NULL et retourne 0 row → tests cassés.
-- Code 365 (Etab. Soins Pluridisciplinaire) en seconde MCO car 354 = SSIAD
-- dans la nomenclature actuelle (ex-"Hôpital privé" obsolète, drift).
INSERT INTO finess
  (num_finess, raison_sociale, categorie_code, categorie_libelle,
   num_voie, type_voie, voie, code_postal, code_departement, code_insee, ville,
   telephone, email, date_ouverture, date_maj, geom)
VALUES
  -- 2 MCO inside 5km
  ('080000017', 'CH Charleville-Mézières', '355', 'Centre Hospitalier (CH)',
   '45', 'AVENUE', 'de Manchester', '08000', '08', '08105', 'Charleville-Mézières',
   '0324583000', NULL, '1950-01-01', '2024-12-01',
   ST_SetSRID(ST_MakePoint(4.7150, 49.7700), 4326)),
  ('080000025', 'Polyclinique du Parc', '365', 'Etablissement de Soins Pluridisciplinaire',
   '12', 'RUE', 'des Tilleuls', '08000', '08', '08105', 'Charleville-Mézières',
   '0324567890', NULL, '1985-06-15', '2024-12-01',
   ST_SetSRID(ST_MakePoint(4.7280, 49.7750), 4326)),

  -- 6 EHPAD inside 5km
  ('080000051', 'EHPAD Les Tilleuls', '500', 'EHPAD',
   '5', 'RUE', 'des Tilleuls', '08000', '08', '08105', 'Charleville-Mézières',
   '0324111111', NULL, '1995-03-10', '2024-11-01',
   ST_SetSRID(ST_MakePoint(4.7100, 49.7680), 4326)),
  ('080000052', 'EHPAD Les Acacias', '500', 'EHPAD',
   '8', 'RUE', 'des Acacias', '08000', '08', '08105', 'Charleville-Mézières',
   '0324222222', NULL, '2001-09-01', '2024-11-01',
   ST_SetSRID(ST_MakePoint(4.7220, 49.7720), 4326)),
  ('080000053', 'EHPAD Soleil Levant', '500', 'EHPAD',
   '14', 'AVENUE', 'du Soleil', '08000', '08', '08105', 'Charleville-Mézières',
   '0324333333', NULL, '2010-04-20', '2024-11-01',
   ST_SetSRID(ST_MakePoint(4.7050, 49.7800), 4326)),
  ('080000054', 'EHPAD Bel Horizon', '500', 'EHPAD',
   '22', 'RUE', 'du Bel Horizon', '08000', '08', '08105', 'Charleville-Mézières',
  ...
  ('080000055', 'Maison de retraite La Roseraie', '501', 'Maison de retraite',
   '3', 'RUE', 'de la Roseraie', '08000', '08', '08105', 'Charleville-Mézières',
  ...
  ('080000056', 'Logement-foyer Les Glycines', '502', 'Logement-foyer',
   '17', 'RUE', 'des Glycines', '08000', '08', '08105', 'Charleville-Mézières',
  ...
  ('080000091', 'Laboratoire d''analyses', '611', 'Laboratoire d''analyses de biologie médicale',
   '6', 'AVENUE', 'du Rein', '08000', '08', '08105', 'Charleville-Mézières',
  ...
  ('080000092', 'Maison de Santé', '603', 'Maison de Santé Pluri-pro (MSP)',
   '11', 'RUE', 'du Médecin', '08000', '08', '08105', 'Charleville-Mézières',
  ...
  ('080000101', 'EHPAD Sedan', '500', 'EHPAD',
   '20', 'RUE', 'Principale', '08200', '08', '08409', 'Sedan',
  ...
  ('080000102', 'CH Sedan', '355', 'Centre Hospitalier (CH)',
   '15', 'AVENUE', 'de Verdun', '08200', '08', '08409', 'Sedan',
  ...
  ('080000201', 'Établissement Test', '9999', 'Catégorie Inconnue',
   '1', 'RUE', 'du Test', '08000', '08', '08105', 'Charleville-Mézières',
  ...
  ('080000202', 'Établissement Sans Coords', '500', 'EHPAD',
   '99', 'RUE', 'Mystère', '08000', '08', '08105', 'Charleville-Mézières',
